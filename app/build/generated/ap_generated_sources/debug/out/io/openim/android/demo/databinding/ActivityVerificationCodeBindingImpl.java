...
public class ActivityVerificationCodeBindingImpl extends ActivityVerificationCodeBinding  {
    ...
    static {
        ...
        sViewsWithIds.put(R.id.codeEditText, 6);
        sViewsWithIds.put(R.id.resend, 7);
    ...
    private ActivityVerificationCodeBindingImpl(androidx.databinding.DataBindingComponent bindingComponent, View root, Object[] bindings) {
        super(bindingComponent, root, 3
            ...
            , (io.openim.android.ouicore.widget.CodeEditText) bindings[6]
    ...
    protected boolean onFieldChange(int localFieldId, Object object, int fieldId) {
        switch (localFieldId) {
            ...
            case 1 :
                return onChangeLoginVMCountdown((io.openim.android.ouicore.base.vm.State<java.lang.Integer>) object, fieldId);
            case 2 :
    ...
    private boolean onChangeLoginVMCountdown(io.openim.android.ouicore.base.vm.State<java.lang.Integer> LoginVMCountdown, int fieldId) {
        if (fieldId == BR._all) {
            synchronized(this) {
                    mDirtyFlags |= 0x2L;
            }
    ...
    protected void executeBindings() {
        ...
        java.lang.String loginVMIsPhoneBaseAppInstGetStringIoOpenimAndroidOuicoreRStringVerificationCodeSendPhoneBaseAppInstGetStringIoOpenimAndroidOuicoreRStringVerificationCodeSendMail = null;
        io.openim.android.ouicore.base.vm.State<java.lang.Boolean> loginVMIsPhone = null;
        io.openim.android.ouicore.base.vm.State<java.lang.Integer> loginVMCountdown = null;
        io.openim.android.demo.vm.LoginVM loginVM = mLoginVM;
        ...
        if ((dirtyFlags & 0x1fL) != 0) {
            ...
            if ((dirtyFlags & 0x19L) != 0) {
                ...
                if((dirtyFlags & 0x19L) != 0) {
                    ...
                    // read androidx.databinding.ViewDataBinding.safeUnbox(LoginVM.isPhone.getValue()) ? BaseApp.inst().getString(io.openim.android.ouicore.R.string.verification_code_send_phone) : BaseApp.inst().getString(io.openim.android.ouicore.R.string.verification_code_send_mail)
                    loginVMIsPhoneBaseAppInstGetStringIoOpenimAndroidOuicoreRStringVerificationCodeSendPhoneBaseAppInstGetStringIoOpenimAndroidOuicoreRStringVerificationCodeSendMail = ((androidxDatabindingViewDataBindingSafeUnboxLoginVMIsPhoneGetValue) ? (io.openim.android.ouicore.base.BaseApp.inst().getString(io.openim.android.ouicore.R.string.verification_code_send_phone)) : (io.openim.android.ouicore.base.BaseApp.inst().getString(io.openim.android.ouicore.R.string.verification_code_send_mail)));
            }
        ...
        if ((dirtyFlags & 0x19L) != 0) {
            ...
            androidx.databinding.adapters.TextViewBindingAdapter.setText(this.tips, loginVMIsPhoneBaseAppInstGetStringIoOpenimAndroidOuicoreRStringVerificationCodeSendPhoneBaseAppInstGetStringIoOpenimAndroidOuicoreRStringVerificationCodeSendMail);
        }
    }
    ...
    /* flag mapping
        ...
        flag 3 (0x4L): LoginVM
        flag 4 (0x5L): null
        flag 5 (0x6L): androidx.databinding.ViewDataBinding.safeUnbox(LoginVM.isPhone.getValue()) ? BaseApp.inst().getString(io.openim.android.ouicore.R.string.verification_code_send_phone) : BaseApp.inst().getString(io.openim.android.ouicore.R.string.verification_code_send_mail)
        flag 6 (0x7L): androidx.databinding.ViewDataBinding.safeUnbox(LoginVM.isPhone.getValue()) ? BaseApp.inst().getString(io.openim.android.ouicore.R.string.verification_code_send_phone) : BaseApp.inst().getString(io.openim.android.ouicore.R.string.verification_code_send_mail)
