...
public class ActivitySearchPersonBindingImpl extends ActivitySearchPersonBinding  {
    ...
    protected void executeBindings() {
        ...
        int searchVMIsPersonIoOpenimAndroidOuicoreRStringNotFindUserIoOpenimAndroidOuicoreRStringNotFindGroup = 0;
        ...
        if ((dirtyFlags & 0x3L) != 0) {
            ...
            if((dirtyFlags & 0x3L) != 0) {
                ...
                // read SearchVM.isPerson ? io.openim.android.ouicore.R.string.not_find_user : io.openim.android.ouicore.R.string.not_find_group
                searchVMIsPersonIoOpenimAndroidOuicoreRStringNotFindUserIoOpenimAndroidOuicoreRStringNotFindGroup = ((searchVMIsPerson) ? (io.openim.android.ouicore.R.string.not_find_user) : (io.openim.android.ouicore.R.string.not_find_group));
        }
        // batch finished
        if ((dirtyFlags & 0x3L) != 0) {
            // api target 1

            this.notFind.setText(searchVMIsPersonIoOpenimAndroidOuicoreRStringNotFindUserIoOpenimAndroidOuicoreRStringNotFindGroup);
        }
    }
    ...
    /* flag mapping
        ...
        flag 1 (0x2L): null
        flag 2 (0x3L): SearchVM.isPerson ? io.openim.android.ouicore.R.string.not_find_user : io.openim.android.ouicore.R.string.not_find_group
        flag 3 (0x4L): SearchVM.isPerson ? io.openim.android.ouicore.R.string.not_find_user : io.openim.android.ouicore.R.string.not_find_group
    flag mapping end*/
    //end
}