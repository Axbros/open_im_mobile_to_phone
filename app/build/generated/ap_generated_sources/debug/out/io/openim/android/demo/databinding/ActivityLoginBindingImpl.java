...
public class ActivityLoginBindingImpl extends ActivityLoginBinding  {
    ...
    static {
        ...
        sViewsWithIds.put(R.id.phoneTv, 7);
        sViewsWithIds.put(R.id.phoneVv, 8);
        sViewsWithIds.put(R.id.submit, 9);
        sViewsWithIds.put(R.id.protocol, 10);
        sViewsWithIds.put(R.id.version, 11);
    }
    // views
    @NonNull
    ...
    private ActivityLoginBindingImpl(androidx.databinding.DataBindingComponent bindingComponent, View root, Object[] bindings) {
        super(bindingComponent, root, 2
            , (io.openim.android.demo.databinding.LayoutLoginBinding) bindings[5]
