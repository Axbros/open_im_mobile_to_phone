...
public class ActivityLoginBindingImpl extends ActivityLoginBinding  {
    ...
    static {
        ...
        sViewsWithIds.put(R.id.welcome, 5);
        sViewsWithIds.put(R.id.phoneTv, 6);
        sViewsWithIds.put(R.id.phoneVv, 7);
        sViewsWithIds.put(R.id.submit, 8);
        sViewsWithIds.put(R.id.protocol, 9);
    ...
    private ActivityLoginBindingImpl(androidx.databinding.DataBindingComponent bindingComponent, View root, Object[] bindings) {
        super(bindingComponent, root, 1
            , (io.openim.android.demo.databinding.LayoutLoginBinding) bindings[4]
