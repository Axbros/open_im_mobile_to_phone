...
public class ActivitySendVerifyBindingImpl extends ActivitySendVerifyBinding  {
    ...
    private androidx.databinding.InverseBindingListener hailandroidTextAttrChanged = new androidx.databinding.InverseBindingListener() {
        ...
        public void onChange() {
            ...
            // SearchVM.hail
            io.openim.android.ouicore.base.vm.State<java.lang.String> searchVMHail = null;
            // SearchVM
    ...
    private ActivitySendVerifyBindingImpl(androidx.databinding.DataBindingComponent bindingComponent, View root, Object[] bindings) {
        super(bindingComponent, root, 1
            , (bindings[5] != null) ? io.openim.android.ouicore.databinding.ViewBackBinding.bind((android.view.View) bindings[5]) : null
    ...
    protected boolean onFieldChange(int localFieldId, Object object, int fieldId) {
        switch (localFieldId) {
            case 0 :
                return onChangeSearchVMHail((io.openim.android.ouicore.base.vm.State<java.lang.String>) object, fieldId);
        }
        return false;
    }
    private boolean onChangeSearchVMHail(io.openim.android.ouicore.base.vm.State<java.lang.String> SearchVMHail, int fieldId) {
        if (fieldId == BR._all) {
            synchronized(this) {
                    mDirtyFlags |= 0x1L;
            }
        ...
        if ((dirtyFlags & 0x7L) != 0) {
            ...
            if ((dirtyFlags & 0x6L) != 0) {
                ...
                if((dirtyFlags & 0x6L) != 0) {
                    ...
                    searchVMIsPersonMboundView2AndroidStringFriendVerifyMboundView2AndroidStringGroupVerify = ((searchVMIsPerson) ? (mboundView2.getResources().getString(io.openim.android.ouicore.R.string.friend_verify)) : (mboundView2.getResources().getString(io.openim.android.ouicore.R.string.group_verify)));
                    // read SearchVM.isPerson ? @android:string/send_friend_apply : @android:string/send_join_group_apply
                    searchVMIsPersonMboundView3AndroidStringSendFriendApplyMboundView3AndroidStringSendJoinGroupApply = ((searchVMIsPerson) ? (mboundView3.getResources().getString(io.openim.android.ouicore.R.string.send_friend_apply)) : (mboundView3.getResources().getString(io.openim.android.ouicore.R.string.send_join_group_apply)));
            }
