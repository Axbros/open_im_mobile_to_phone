...
public class ActivityAccountSettingBindingImpl extends ActivityAccountSettingBinding  {
    ...
    static {
        ...
        sViewsWithIds.put(R.id.messageTone, 4);
        sViewsWithIds.put(R.id.vibration, 5);
        sViewsWithIds.put(R.id.notAdd, 6);
        sViewsWithIds.put(R.id.blackList, 7);
        sViewsWithIds.put(R.id.languageSetting, 8);
        sViewsWithIds.put(R.id.changePassword, 9);
        sViewsWithIds.put(R.id.clearRecord, 10);
    }
    // views
    @NonNull
    ...
    private ActivityAccountSettingBindingImpl(androidx.databinding.DataBindingComponent bindingComponent, View root, Object[] bindings) {
        super(bindingComponent, root, 0
            ...
            , (io.openim.android.ouicore.widget.SlideButton) bindings[4]
            , (io.openim.android.ouicore.widget.SlideButton) bindings[6]
            , (io.openim.android.ouicore.widget.SlideButton) bindings[3]
            , (io.openim.android.ouicore.widget.SlideButton) bindings[5]
            );
